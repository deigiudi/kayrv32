...
#
# Generated by Vivado on Wed Apr 08 13:28:43 CEST 2020
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../BenchRV32.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../BenchRV32.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/mnt/hgfs/RISC-V/1_Cores/Verilog_BenchRV32I/vivado/BenchRV32.cache/compile_simlib/vcs"
  fi
